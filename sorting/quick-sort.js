...
//quickSort With No Additional Data Structures
function quickSortW(arr, left = 0, right= arr.length-1) { 
    if (left < right) {
        const pivot = partition(arr, left, right)
        quickSortW(arr, left, pivot - 1)
        quickSortW(arr, pivot + 1, right)
      }
      return arr
}
...
function swap(arr, i, j) {
 ...
 console.log('quickSortW', quickSortW([-6, 20, 8, -2, 4])) // output [-6, -2, 4, 8, 20
 console.log('quickSortW', quickSortW([-8, 20, -2, 4, -6])) // output [-8, -6, -2, 4, 20]
