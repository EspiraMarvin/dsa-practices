...
Factorial of 0 or 0! is 1
Factorial of 1 is 1

eg.
factorial(4) or 4! = 4*3*2*1 = 24
factorial(5) or 5! = 5*4*3*2*1 = 120
...
Solution - 
    ...
    - loop over n and multiply each number with the result variable // result *= 1 same as result = result * 1
